...
/**
 * An abstract class that defines all shader programs.
 * @author Blackened
 */
public abstract class ShaderProgram {
    ...
    /**
     * Used only to load matrices into uniform variables.
     */
     ...
     * @param vertexFile The contents of the vertex shader file.
     * @param fragmentFile The contents of the fragment shader file.
     */
    ...
    /**
     * Loads a float value to the uniform variable in specified location.
     ...
     * @param location The location of the uniform variable to which the 
     * matrix needs to be loaded.
